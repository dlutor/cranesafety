...
def run_demo(opt):
    ...
    if opt.input_mode == 'video':
        ...
        with open(opt.input_img, 'r', encoding='utf-8') as r_h:
            ...
            data_loader = datasets.LoadImages(path=paths, img_size=opt.img_size,data_root=dataset_root)
    ...
    if opt.output_format == 'video':
        ...
        if opt.input_mode == 'video':
            ...
            output_video_path= osp.join(result_root,  'result_track.mp4')
        cmd_str = 'ffmpeg -f image2 -i {}/%05d.jpg -b 5000k -c:v mpeg4 {} -y' \
